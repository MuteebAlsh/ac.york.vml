 ...
 *   <li>{@link vml.impl.PieImpl#getStyle <em>Style</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PieImpl extends DiagramImpl implements Pie {
	 ...
	 * @ordered
	 */
	protected ChartWithoutAxisStyle style;
	 ...
	 * @generated
	 */
	public ChartWithoutAxisStyle getStyle() {
		return style;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStyle(ChartWithoutAxisStyle newStyle, NotificationChain msgs) {
		ChartWithoutAxisStyle oldStyle = style;
		style = newStyle;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VmlPackage.PIE__STYLE, oldStyle, newStyle);
	 ...
	 * @generated
	 */
	public void setStyle(ChartWithoutAxisStyle newStyle) {
		if (newStyle != style) {
			NotificationChain msgs = null;
			if (style != null)
				msgs = ((InternalEObject)style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VmlPackage.PIE__STYLE, null, msgs);
			if (newStyle != null)
				msgs = ((InternalEObject)newStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VmlPackage.PIE__STYLE, null, msgs);
			msgs = basicSetStyle(newStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmlPackage.PIE__STYLE, newStyle, newStyle));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case VmlPackage.PIE__SLICES:
				...
				return;
			case VmlPackage.PIE__STYLE:
				setStyle((ChartWithoutAxisStyle)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case VmlPackage.PIE__SLICES:
				...
				return;
			case VmlPackage.PIE__STYLE:
				setStyle((ChartWithoutAxisStyle)null);
				return;
		}
