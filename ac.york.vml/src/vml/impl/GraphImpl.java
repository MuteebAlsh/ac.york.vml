 ...
 * </p>
 * <ul>
 *   <li>{@link vml.impl.GraphImpl#getID <em>ID</em>}</li>
 ...
 * @generated
 */
public class GraphImpl extends DiagramImpl implements Graph {
	/**
	...
	protected EClass eStaticClass() {
		return VmlPackage.Literals.GRAPH;
	}
	...
	public void setID(Integer newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmlPackage.GRAPH__ID, oldID, id));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmlPackage.GRAPH__TITLE, oldTitle, title));
	}
	...
	public EList<Node> getNodes() {
		if (nodes == null) {
			nodes = new EObjectContainmentEList<Node>(Node.class, this, VmlPackage.GRAPH__NODES);
		}
		return nodes;
	}
	...
	public EList<Edge> getEdges() {
		if (edges == null) {
			edges = new EObjectContainmentEList<Edge>(Edge.class, this, VmlPackage.GRAPH__EDGES);
		}
		return edges;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VmlPackage.GRAPH__ID:
				return getID();
			case VmlPackage.GRAPH__TITLE:
				return getTitle();
			case VmlPackage.GRAPH__NODES:
				return getNodes();
			case VmlPackage.GRAPH__EDGES:
