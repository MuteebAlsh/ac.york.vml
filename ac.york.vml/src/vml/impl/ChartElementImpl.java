 ...
 *   <li>{@link vml.impl.ChartElementImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link vml.impl.ChartElementImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChartElementImpl extends DiagramElementImpl implements ChartElement {
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmlPackage.CHART_ELEMENT__TITLE, oldTitle, title));
	}
	...
	public void setValue(Double newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmlPackage.CHART_ELEMENT__VALUE, oldValue, value));
	}
