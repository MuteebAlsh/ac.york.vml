...
/**
 * This is the item provider adapter for a {@link vml.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VmlPackage.Literals.DIAGRAM__TITLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VmlPackage.Literals.DIAGRAM__PIES);
			childrenFeatures.add(VmlPackage.Literals.DIAGRAM__GRAPH);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VmlPackage.Literals.DIAGRAM__PIES,
				 VmlFactory.eINSTANCE.createPie()));

		newChildDescriptors.add
			(createChildParameter
				(VmlPackage.Literals.DIAGRAM__GRAPH,
