...
public class PieItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pie_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pie_ID_feature", "_UI_Pie_type"),
				 VmlPackage.Literals.PIE__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Integer labelValue = ((Pie)object).getID();
