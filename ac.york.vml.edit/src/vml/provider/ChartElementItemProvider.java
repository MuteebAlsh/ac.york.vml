...
/**
 * This is the item provider adapter for a {@link vml.ChartElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChartElementItemProvider extends DiagramElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ChartElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChartElement_ID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChartElement_ID_feature", "_UI_ChartElement_type"),
				 VmlPackage.Literals.CHART_ELEMENT__ID,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChartElement"));
	}
	...
	public String getText(Object object) {
		Integer labelValue = ((ChartElement)object).getID();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_ChartElement_type") :
			getString("_UI_ChartElement_type") + " " + label;
	}
