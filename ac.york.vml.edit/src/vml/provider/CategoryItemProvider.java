...
/**
 * This is the item provider adapter for a {@link vml.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VmlPackage.Literals.CATEGORY__CATEGORY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Category)object).getCategory();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Category.class)) {
			case VmlPackage.CATEGORY__CATEGORY:
