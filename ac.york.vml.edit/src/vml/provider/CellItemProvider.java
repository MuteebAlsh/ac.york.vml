...
/**
 * This is the item provider adapter for a {@link vml.Cell} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CellItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cell_col_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cell_col_feature", "_UI_Cell_type"),
				 VmlPackage.Literals.CELL__COL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTextValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cell_textValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cell_textValue_feature", "_UI_Cell_type"),
				 VmlPackage.Literals.CELL__TEXT_VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Cell)object).getTextValue();
